    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-gray-50 flex items-center justify-center">
        <div className="bg-white rounded-2xl shadow-xl p-8 text-center border border-gray-100">
          ...
          <p className="mt-4 text-[#081B37] font-medium">Loading project...</p>
        </div>
      </div>
    );
  }
            ...
            <div className="space-y-8">
              ...
              <div>
                <label className="block text-sm font-semibold text-[#081B37] mb-2">
                  <div className="flex items-center gap-2">
                    <FolderOpen size={16} />
                    {currentImage ? 'Change Image' : 'Project Image'}
                  </div>
                </label>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-white/80 backdrop-blur-sm rounded-xl border border-gray-100 p-4 shadow-lg">
            ...
            <ul className="text-xs text-gray-600 space-y-1">
              <li>• Update project details to keep information current</li>
