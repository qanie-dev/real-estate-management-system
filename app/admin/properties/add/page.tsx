...
export default function AddPropertyPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      formData.append("categoryId", form.categoryId); // ✅ Sending as categoryId
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-500 mt-1 flex items-center gap-2">
              ...
              Fill all property information to create a new listing
            </p>
          </div>
          <button
            onClick={() => router.back()}
        ...
        >
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              ...
              <input
                ...
                placeholder="Enter property title (e.g., Luxury Villa in DHA)"
                value={form.title}
                onChange={(e) =>
            ...
            <div>
              ...
              <input
                ...
                placeholder="Enter property price (e.g., 25000000)"
                value={form.price}
                onChange={(e) =>
            ...
            <div>
              ...
              <input
                ...
                placeholder="Enter specific location (e.g., DHA Phase 6)"
                value={form.location}
                onChange={(e) =>
          ...
          <div className="flex gap-4 pt-4 border-t border-gray-200">
            <button
              type="submit"
              disabled={submitting}
              className="flex items-center gap-2 bg-gradient-to-r from-[#081B37] to-[#0d2956] text-white px-8 py-3.5 rounded-xl hover:shadow-lg transition-all duration-300 hover:scale-105 group disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
            >
              {submitting ? (
                <>
